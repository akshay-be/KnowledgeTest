...
public class ElevatorControlSystem implements ElevatorControlSystemFactory {
	...
	public ElevatorControlSystem(Integer numberOfElevators,
			Integer numberOfFloors) throws InvalidNumber {
