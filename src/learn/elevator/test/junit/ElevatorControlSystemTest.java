package learn.elevator.test.junit;

import learn.elevator.impl.Elevator;
import learn.elevator.impl.ElevatorControlSystem;
import learn.elevator.impl.exceptions.InvalidNumber;
...
public class ElevatorControlSystemTest {
	...
	public void testRequestingOneElevator() {
		...
		assertEquals(TENTH_FLOOR, elevators.get(ELEVATOR_ID_ZERO)
				.currentFloor());
	}
	...
	public void testCallingTwoElevators() {
		...
		assertEquals(TENTH_FLOOR, elevators.get(ELEVATOR_ID_ZERO)
				.currentFloor());
		assertEquals(SEVENTH_FLOOR, elevators.get(ELEVATOR_ID_ONE)
				.currentFloor());
	}
	...
	public void testSendingElevatorToMultipleDestinations() {
		...
		elevators = elevatorControlSystem.getElevators();
		assertEquals(SEVENTH_FLOOR, elevators.get(ELEVATOR_ID_ZERO)
				.currentFloor());
	}
